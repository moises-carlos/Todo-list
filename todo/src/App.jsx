...
// Lê a URL da API da variável de ambiente do Vite, com um fallback para o ambiente local.
const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:3001/api/v1/todos';
